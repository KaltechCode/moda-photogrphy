  ...
  if (typeof window !== "undefined") {
    if ($("body").not(".is-mobile").hasClass("tp-magic-cursor")) {
      ...
      function callParallax(
        e: JQuery.MouseMoveEvent<HTMLElement, null, HTMLElement, HTMLElement>,
        parent: HTMLElement,
      ) {
      ...
      function parallaxIt(
        ...
        parent: { getBoundingClientRect: () => any },
        ...
        $(this)
          .on("mouseenter", function () {
            if ($("#ball").find(".ball-view").length === 0) {
              ...
              const cursorText = $(this).attr("data-cursor");
              if (cursorText) {
                $(".ball-view").append(cursorText);
              }
              gsap.to($ball, {
                duration: 0.3,
                yPercent: -75,
